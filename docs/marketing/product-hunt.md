...
IBANforge validates IBANs and looks up BIC/SWIFT codes for 89 countries, with SEPA compliance data, issuer classification (bank vs EMI/neobank), and risk indicators. Built for developers and AI agents.
