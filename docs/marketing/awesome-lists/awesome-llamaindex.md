...
- Datasets: 121k+ BICs from public sources (GLEIF, SWIFT directory, Bundesbank, SIX, NBP, EBA Step2 SCT — with LEI enrichment for the 39k+ GLEIF rows), 1,100+ Swiss BC-Nummer (SIX BankMaster — full payment-rail participation + QR-IID, the deepest Swiss clearing data in any public API)
