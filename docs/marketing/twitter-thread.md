...
89 countries. 121k+ BIC entries (39k+ LEI-enriched via GLEIF). MCP integration for AI agents.
...
- Swiss clearing data -- 1,100+ BC-Nummer entries from SIX (SIC, euroSIC, Instant Payments, QR-IID)
- Open data -- 121k+ BIC entries (39k+ LEI-enriched via GLEIF, CC0)
...
- Swiss clearing: 1,100+ BC-Nummer from SIX (SIC, euroSIC, Instant Payments)
