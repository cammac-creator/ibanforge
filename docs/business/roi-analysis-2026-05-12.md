...
| 4 | Jérôme Kehrli | CTO | Customer F (Yverdon) | **Warm via blog/Twitter** |
...
| 8 | Thomas Suter | CTO & Co-founder | Customer G (Zurich) | Cold ciblé (partenariat) |
| 9 | Philip Schoch | CEO & Co-founder | Customer G | Cold ciblé |
...
2. **Customer F / Customer F** — pas de couche BC-Nummer/QR-IID. Pitch : feed enrichment Swiss-specific.
