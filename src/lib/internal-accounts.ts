...
export const INTERNAL_EMAIL_RE =
  ...
  /(@ibanforge\.com|@ibanforge\.internal|@ibf-internal\.dev|-probe@|@example\.com|@test\.|test-|-test|smoke|audit|^ca-[a-z]+-?\d*@proton\.me|^credits-buyer$|^stripe-buyer$|^playground|cammac@bluewin\.ch|cam@ogens\.ch|ptibootch@|gpt-store@)/i;
