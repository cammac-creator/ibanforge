  ...
  const page = html`<!DOCTYPE html>
    <html lang="en">
      <head>
        ...
        <meta
          name="description"
          content="Validate IBANs, lookup BICs, score compliance risk. 121K BICs, 89 countries. Free tier or x402 micropayments. MCP native for AI agents."
        />
        ...
        <meta
          ...
          content="Compliance-grade IBAN intelligence. 121K BICs, bank-level sanctions screening, risk scoring. Free tier + x402 micropayments."
        />
        ...
        <meta
          ...
          content="121K BICs. Compliance scoring. MCP native. Free or pay-per-call with USDC."
        />
        ...
        <style>
          * {
          ...
          .hero-moat {
            ...
            border-radius: 10px;
            background: linear-gradient(135deg, #ef444411, #18181b);
            color: #e5e5e5;
            font-size: 14px;
            line-height: 1.55;
          }
          ...
          .tryit-tab:first-child {
            border-radius: 8px 0 0 0;
          }
          .tryit-tab:last-child {
          ...
          .tryit-input input:focus {
            border-color: #f59e0b;
          }
          .tryit-input input::placeholder {
            color: #52525b;
          }
          .tryit-input button {
            padding: 12px 20px;
          ...
          .tryit-input button:hover {
            background: #eab308;
          }
          .tryit-input button:disabled {
            opacity: 0.5;
            cursor: not-allowed;
          }
          .tryit-result {
          ...
          .stripe-pack-btn:hover {
            border-color: #9b94ff;
            background: rgba(99, 91, 255, 0.06);
          }
          .stripe-pack-btn-best {
            border-color: rgba(99, 91, 255, 0.4);
            background: rgba(99, 91, 255, 0.05);
          }
          .stripe-pack-btn-best:hover {
            border-color: #9b94ff;
          }
          .pack-credits {
          ...
          .keygen-form input:focus {
            border-color: #f59e0b;
          }
          .keygen-form input::placeholder {
            color: #52525b;
          }
          .keygen-form button {
            padding: 12px 20px;
      ...
      <body>
        <nav class="nav">
          <div class="nav-inner">
            ...
            <div class="nav-links">
              ...
              <a href="https://ibanforge.com" class="nav-site" target="_blank"
                >ibanforge.com &rarr;</a
              >
            </div>
          </div>
        </nav>
        <div class="container">
          ...
          <div class="hero">
            ...
            <div class="hero-ctas">
              ...
              <button
                ...
                onclick="document.querySelector('.keygen').classList.toggle('show')"
              >
            ...
            <div class="keygen">
              ...
              <p style="margin:8px 0 0;font-size:11px;color:#52525b">
                ...
                >
                and
                <a href="https://ibanforge.com/legal/privacy" style="color:#71717a"
                  >Privacy Policy</a
                >.
              </p>
          ...
          <div class="tryit" id="tryit">
            ...
            <div class="tryit-tabs">
              <div class="tryit-tab active" data-mode="iban" onclick="switchTab('iban')">
                IBAN Validate
              </div>
              <div class="tryit-tab" data-mode="bic" onclick="switchTab('bic')">BIC Lookup</div>
              <div class="tryit-tab" data-mode="compliance" onclick="switchTab('compliance')">
                <span class="star">&starf;</span> Compliance Check
              </div>
            </div>
          ...
          <div class="features-section">
            ...
            <p class="section-sub">
              Compliance-grade IBAN intelligence for developers and AI agents.
            </p>
            <div class="features-grid">
              ...
              <div class="feat-card">
                <div class="feat-icon feat-icon-purple">
                  <svg
                    ...
                    viewBox="0 0 24 24"
                  >
                    <path d="M12 2a4 4 0 0 0-4 4c0 2 2 3 2 6h8c0-3 2-4 2-6a4 4 0 0 0-4-4z" />
              ...
              <div class="feat-card">
                ...
                <p>
                  Pay per call with USDC on Base L2. No subscription, no signup. Machine-to-machine
                  native.
                </p>
              </div>
              <div class="feat-card">
                ...
                <p>
                  SCT, SDD, SCT_INST reachability check. Verification of Payee participant status
                  per BIC.
                </p>
              </div>
              <div class="feat-card">
          ...
          <div class="pricing-section" id="pricing">
            ...
            <div class="pricing-paths">
              <div class="path-card path-free">
                ...
                <button
                  class="path-cta path-cta-outline"
                  onclick="document.querySelector('.hero').scrollIntoView({behavior:'smooth'});setTimeout(()=>document.querySelector('.keygen').classList.add('show'),400)"
                >
                  Get free API key
                </button>
              </div>
              <div class="path-card path-stripe">
                ...
                <div class="stripe-buttons" data-stripe-guard="true">
                  ...
                  <a
                    href="${PAYMENT_LINKS['5k']}"
                    class="stripe-pack-btn stripe-pack-btn-best"
                    data-stripe-bundle="5k"
                  >
                  ...
                  <a
                    href="${PAYMENT_LINKS['25k']}"
                    class="stripe-pack-btn"
                    data-stripe-bundle="25k"
                  >
              ...
              <div class="path-card path-x402">
                ...
                <h3>x402 / USDC</h3>
                <p class="path-price">
                  <strong>From $0.003/call</strong> &mdash; no account needed
                </p>
                <ul class="path-features">
                  <li><span class="check">&check;</span> All endpoints included</li>
            ...
            <table>
              ...
              <tbody>
                <tr>
                  <td>POST /v1/iban/validate</td>
                  <td>$0.005</td>
                </tr>
                <tr>
                  <td>POST /v1/iban/batch</td>
                  <td>$0.002/IBAN</td>
                </tr>
                <tr>
                  <td>GET /v1/bic/:code</td>
                  <td>$0.003</td>
                </tr>
                <tr>
                  <td>POST /v1/iban/compliance</td>
                  <td>$0.020</td>
                </tr>
                <tr>
                  <td>GET /v1/ch/clearing/:iid</td>
                  <td>$0.003</td>
                </tr>
              </tbody>
            </table>
          ...
          <div class="quickstart-section" id="quickstart">
            ...
            <div class="qs-code active" data-lang="curl">
              <span class="c"># Validate an IBAN (free with API key)</span>
              <span class="g">curl</span> -X POST https://api.ibanforge.com/v1/iban/validate \\ -H
              <span class="s">"Content-Type: application/json"</span> \\ -H
              <span class="s">"Authorization: Bearer ifk_your_key_here"</span> \\ -d
              <span class="s">'{"iban": "GB29NWBK60161331926819"}'</span>

              <span class="c"># Or pay per call with x402 — no key needed</span>
              <span class="g">curl</span> -X POST https://api.ibanforge.com/v1/iban/validate \\ -H
              <span class="s">"Content-Type: application/json"</span> \\ -H
              <span class="s">"PAYMENT-SIGNATURE: &lt;x402-payment-header&gt;"</span> \\ -d
              <span class="s">'{"iban": "DE89370400440532013000"}'</span>
            </div>
            <div class="qs-code" data-lang="js">
              <span class="k">const</span> res = <span class="k">await</span>
              <span class="f">fetch</span>(<span class="s"
                >'https://api.ibanforge.com/v1/iban/validate'</span
              >, { method: <span class="s">'POST'</span>, headers: {
              <span class="s">'Content-Type'</span>: <span class="s">'application/json'</span>,
              <span class="s">'Authorization'</span>:
              <span class="s">'Bearer ifk_your_key_here'</span>, }, body: JSON.<span class="f"
                >stringify</span
              >({ iban: <span class="s">'GB29NWBK60161331926819'</span> }), });
              <span class="k">const</span> data = <span class="k">await</span> res.<span class="f"
                >json</span
              >(); console.<span class="f">log</span>(data);
              <span class="c">// x402: omit Authorization header, add X-Payment instead</span>
            </div>
            <div class="qs-code" data-lang="python">
              <span class="k">import</span> requests res = requests.<span class="f">post</span>(
              <span class="s">"https://api.ibanforge.com/v1/iban/validate"</span>, headers={
              <span class="s">"Content-Type"</span>: <span class="s">"application/json"</span>,
              <span class="s">"Authorization"</span>:
              <span class="s">"Bearer ifk_your_key_here"</span>, }, json={<span class="s"
                >"iban"</span
              >: <span class="s">"GB29NWBK60161331926819"</span>}, )
              <span class="f">print</span>(res.<span class="f">json</span>())
              <span class="c"># x402: omit Authorization header, add X-Payment instead</span>
            </div>
            <div class="qs-code" data-lang="sdk">
              <span class="k">import</span> { IBANforge } <span class="k">from</span>
              <span class="s">'@ibanforge/sdk'</span>;

              <span class="k">const</span> client = <span class="k">new</span>
              <span class="f">IBANforge</span>(<span class="s">'ifk_your_key_here'</span>);

              <span class="k">const</span> result = <span class="k">await</span> client.<span
                class="f"
                >validate</span
              >(<span class="s">'GB29NWBK60161331926819'</span>); console.<span class="f">log</span
              >(result);

              <span class="c">// Batch validation</span>
              <span class="k">const</span> batch = <span class="k">await</span> client.<span
                class="f"
                >batchValidate</span
              >([ <span class="s">'GB29NWBK60161331926819'</span>,
            ...
            <div class="footer-links">
              <a href="/openapi.json" class="footer-link"
                ><span>/openapi.json</span> &mdash; OpenAPI spec</a
              >
              ...
              <a href="https://www.npmjs.com/package/@ibanforge/sdk" class="footer-link"
                ><span>npm</span> &mdash; @ibanforge/sdk</a
              >
            </div>
          </div>
          ...
          <div class="footer-bottom">
            <p>
              IBANforge v${pkg.version} &mdash; <a href="https://ibanforge.com">ibanforge.com</a>
            </p>
          </div>
        </div>
        ...
        <script>
          ...
          document
            .querySelectorAll('[data-stripe-guard="true"] a[href^="STRIPE_PAYMENT_LINK_"]')
            .forEach(function (a) {
              a.addEventListener('click', function (e) {
                e.preventDefault();
                alert(
                  'Stripe Payment Links not yet configured. Email support@ibanforge.com to purchase credits manually for now.',
                );
              });
            });
          let mode = 'iban';
          function switchTab(m) {
            ...
            if (m === 'iban') {
              ...
              input.placeholder = 'DE89370400440532013000';
          ...
          function cj(o, i) {
            ...
            if (typeof o === 'string')
              return '<span class="json-str">"' + o.replace(/</g, '&lt;') + '"</span>';
            if (Array.isArray(o)) {
              if (!o.length) return '[]';
            ...
            return (
              '{\\n' +
              k
                .map((x) => p + '  <span class="json-key">"' + x + '"</span>: ' + cj(o[x], i + 1))
                .join(',\\n') +
              '\\n' +
              p +
              '}'
          ...
          function _pg(type, value) {
            return fetch('/internal/playground', {
              method: 'POST',
              headers: _ah,
          ...
          async function submit() {
            ...
            try {
              ...
              if (mode === 'compliance') {
                ...
                var ok = !data.error;
                res.innerHTML =
                  '<div class="tryit-status"><span class="' +
                  (ok ? 'tryit-valid' : 'tryit-invalid') +
                  '">' +
                  (ok ? '✓ Compliance Check' : '✗ Error') +
                  '</span><span class="tryit-ms">' +
                  ms +
                  'ms</span></div>' +
                  cj(data);
          ...
          function switchLang(l) {
            ...
            document
              .querySelectorAll('.qs-code')
              .forEach((c) => c.classList.toggle('active', c.dataset.lang === l));
          }
          async function generateKey(e) {
            ...
            errEl.className = 'keygen-error';
            resEl.className = 'keygen-result';
            try {
              ...
              if (!r.ok) {
                ...
                errEl.className = 'keygen-error show';
                return false;
              }
              keyEl.textContent = d.api_key;
              resEl.className = 'keygen-result show';
              form.email.value = '';
            } catch (err) {
