...
landing.get('/', (c) => {
  ...
  const jsonLdFAQ = JSON.stringify({
    ...
    "mainEntity":[
      ...
      {"@type":"Question","name":"Can AI agents use IBANforge?","acceptedAnswer":{"@type":"Answer","text":"Yes. IBANforge is MCP-native with 8 tools for AI agents: validate_iban, batch_validate_iban, lookup_bic, check_compliance, lookup_ch_clearing, validate_payment_reference, and check_postal_address. Compatible with Claude, GPT, and any MCP client."}},
    ...
    <div class="features-section">
      ...
      <div class="features-grid">
        ...
        <div class="feat-card">
          ...
          <h3>MCP Native</h3>
          <p>8 tools for AI agents via Model Context Protocol. Works with Claude, GPT, and any MCP client.</p>
        </div>
        <div class="feat-card">
  ...
  <span class="s">'DE89370400440532013000'</span>,
      ...
      <div class="mcp-callout">
        ...
        <div>
          ...
          <p>Add IBANforge to your agent with <code>npm run mcp</code> &mdash; exposes 8 tools via stdio transport. Compatible with Claude Desktop, Cursor, and any MCP client.</p>
        </div>
      </div>
