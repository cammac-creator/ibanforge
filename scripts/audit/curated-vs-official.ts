 ...
 * - Register countries (CH/LI/DE/AT/BE/SK/CZ/SM/IT/FI/GB/GI) are excluded: their names are
 *   already confronted with the national register itself (Italy since 25/09/2026).
...
const REGISTER_COUNTRIES = new Set(['CH', 'LI', 'DE', 'AT', 'BE', 'SK', 'CZ', 'SM', 'IT', 'FI', 'GB', 'GI']);
