...
const fixture: AuditStatus = { job: "exemple-fictif", rows: 1, tier: "small", price: 149, currency: "USD", lang: "fr", paid: false, paid_at: null, expires_at: "2026-12-01", summary: { rows: 1, ok: 1, warning: 0, error: 0, by_code: {}, countries: [], columns_detected: ["IBAN"], address_checked: false }, preview: [{ line: 2, iban_masked: "CH•• ••••", status: "ok", findings: [], bank_name: "Banque fictive" }], download: null };
