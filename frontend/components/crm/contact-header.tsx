  ...
  return (
    <div className="mb-3 min-w-0 border-b border-[var(--ink-4)]/60 pb-3">
      ...
      {/* Anything carrying a prospect row can hold an outcome, client included:
          ...
          « Rien à répondre » used to sit right here, outside this guard, and
          the guard was the only thing it was written to escape. It escaped the
          wrong enclosure: what buried it was not the prospect row but this
          block, which scrolls. It now lives on the situation band, pinned —
          see no-reply-control.tsx for what the first placement cost. */}
