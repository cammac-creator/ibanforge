...
- **4.2** **Data minimisation by design:** no storage of submitted IBANs; IP addresses stored only as salted hashes; API keys stored only as hashes.
- **4.3** Hosting in the **Zurich (Switzerland)** region (Railway), with volume-level isolation.
