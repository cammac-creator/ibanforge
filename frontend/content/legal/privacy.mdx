...
*Revision 1.3 (September 16, 2026): the website and the dashboard moved from Vercel Inc. (global CDN, USA) to a virtual server operated by Infomaniak Network SA in Geneva, Switzerland — a sub-processor already listed for email. No new sub-processor; the Vercel row is removed.*
...
| Infomaniak Network SA | Website & dashboard hosting (virtual server, Geneva) — customer data transits it when the operator uses the dashboard, and playground submissions are relayed to the API | Switzerland |
