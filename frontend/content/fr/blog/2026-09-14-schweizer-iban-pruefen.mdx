...
description: "Un IBAN suisse passe trois contrôles, pas un : la clé de contrôle, l'IID à cinq chiffres contre le registre de SIX, et la question de savoir si c'est un QR-IBAN qui exige une référence QR. Trois vraies réponses de l'API, champ par champ, avec dix appels par jour sans clé."
date: "2026-09-14"
faq:
  ...
  - q: "Combien coûte la vérification ?"
    a: "Rien pour commencer : dix vérifications par jour et par adresse sans clé, 200 par mois avec la clé gratuite, et chaque IID a sa propre page sous /fr/iid, sans aucun appel."
---
...
La réponse est complète et porte un bloc `trial` qui dit combien d'appels restent aujourd'hui. Pour la production, la [clé gratuite](/fr/docs/api-keys) suffit, 200 requêtes par mois sans carte. Qui ne veut écrire aucune ligne de code : [chaque IID a sa propre page](/fr/iid) avec exactement cette réponse, [le format de l'IBAN suisse avec l'exemple officiel](/fr/iban/ch) est à côté, et le [générateur d'IBAN de test](/fr/tools/test-iban) produit des IBAN suisses avec de vrais IID attribués, pour les fixtures et les démonstrations.
