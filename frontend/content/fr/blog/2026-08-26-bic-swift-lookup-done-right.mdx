...
Identité et permission sont deux questions distinctes. Savoir *qui* est un établissement ne dit pas ce qu'il a le droit de faire. Là où un régulateur publie la réponse, un lookup devrait la porter — et la porter avec sa provenance. `BARCGB22` de nouveau (le nom de l'établissement et son FRN sont omis ici) :
