...
| `lookup_ch_clearing(iid)` | `/v1/ch/clearing/{iid}` | 0,003 $ | ~1 200 entrées SIX BankMaster — participation complète aux rails + QR-IID, la donnée de clearing suisse la plus profonde de toutes les API publiques |
