...
[IBANforge](https://ibanforge.com) est une API REST qui gere la validation complete d'IBAN -- somme de controle, regles pays, analyse BBAN -- et resout le code BIC dans la meme reponse, a partir du jeu de donnees GLEIF de plus de 121 000 entrees utilise par les banques centrales. Une requete POST, une reponse JSON structuree.
