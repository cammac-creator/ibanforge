...
description: "Vérifier un code banque allemand n'est pas un calcul de clé. La Deutsche Bundesbank publie chaque mois quels codes sont attribués, à qui, et lesquels vont disparaître. Trois vraies réponses de l'API, champ par champ ; l'essai sans clé couvre jusqu'à 25 vérifications par semaine."
date: "2026-09-07"
faq:
...
La réponse est complète, et elle porte un bloc `trial` qui dit combien d'appels restent cette semaine. Pour la production, prenez une [clé sans e-mail](/fr/docs/api-keys) : 200 requêtes par mois une fois réclamée, sans carte ; pour vérifier un fichier entier, [`POST /v1/iban/batch`](/fr/docs/iban-validate) prend jusqu'à cent IBAN par appel. Et qui ne veut écrire aucune ligne de code trouve [chaque Bankleitzahl sur sa propre page](/fr/blz), avec exactement cette réponse dessus.
