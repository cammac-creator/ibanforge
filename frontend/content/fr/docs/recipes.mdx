...
Ou le transport hébergé, sans installation : `https://api.ibanforge.com/mcp` — 25 appels d'outils gratuits par semaine et par adresse source, sans aucune clé (semaine ISO en UTC, remise à zéro le lundi à 00:00 UTC) : le chemin le plus rapide pour qu'un assistant évalue la donnée avant tout engagement.
