...
## Python {#valider-un-iban-en-python}
...
## Node.js / TypeScript {#valider-un-iban-en-node}
...
## Google Sheets {#valider-un-iban-dans-google-sheets}
...
## Agents IA (MCP) {#valider-un-iban-avec-un-agent}
