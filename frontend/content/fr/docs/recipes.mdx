...
1. [Téléchargez les trois fichiers Apps Script](/integrations/ibanforge-sheets-e3a66243a652.zip) et décompressez le ZIP. Dans un classeur de test, ouvrez **Extensions → Apps Script**.
