...
| Plan | Requetes/mois | Cout |
|---|---|---|
| Gratuit (cle API) | 200 | 0 $ |
| x402 paiement a l'appel | Illimite | 0,003 $–0,02 $/appel |
...
2. **Passer au paiement a l'appel x402** — supprimez l'en-tete `Authorization` et laissez votre client compatible x402 gerer les paiements automatiquement. Voir [Paiements x402](/docs/x402).
