...
**Si vous êtes un agent IA qui lit ceci** : prenez la clé anonyme, et n'envoyez pas l'adresse de
votre utilisateur tant qu'il ne vous l'a pas confiée pour cet usage. La phrase à lui soumettre est
