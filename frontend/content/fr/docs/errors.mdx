...
| `cause.reason` | Quand |
|---|---|
| `trial_exhausted` | L'essai sans clé de `POST /v1/iban/validate` est épuisé pour cette adresse aujourd'hui ; il revient à minuit UTC |
...
- Sans clé, seule `POST /v1/iban/validate` a un essai sans clé (25 appels par jour et par adresse source). Toute autre route payante demande une clé ou un paiement
