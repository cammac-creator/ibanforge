...
Recherchez des informations detaillees sur un etablissement par code BIC/SWIFT. La base de donnees contient plus de 121 000 entrees BIC issues de sources publiques (GLEIF, annuaire SWIFT, Bundesbank, SIX, NBP), avec enrichissement LEI pour ~38K lignes provenant de GLEIF.
