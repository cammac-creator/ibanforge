...
La Finlande est partie le 25 septembre 2026. Sa transcription manuelle de la liste de Finance Finland, dont l'éditeur n'a jamais confirmé les conditions de réutilisation, a été retirée avec les clés finlandaises de notre carte composite : un code banque finlandais répond désormais `status: "unavailable"` avec `reason: "no_reference_data_for_country"`. Non consulté, jamais refusé. Voir [codes banque finlandais](/docs/fi-bank-codes).
