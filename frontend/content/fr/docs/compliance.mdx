...
description: "POST /v1/iban/compliance — screening sanctions au niveau bancaire (OFAC/EU/ONU/SECO), statut FATF, joignabilité SEPA, participation VoP et score de risque 0–100."
order: 4
---
...
| `sanctions.bank_sanctioned` | La banque teneuse de compte (BIC8) est désignée sur les listes OFAC, UE, ONU ou SECO. |
| `sanctions.matched_lists` | Les listes concernées, p. ex. `["OFAC", "EU"]`. Vide si rien ne matche. |
