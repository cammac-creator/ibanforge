...
description: "POST /v1/iban/compliance — screening sanctions au niveau bancaire (OFAC), statut FATF, joignabilité SEPA, participation VoP et score de risque 0–100."
order: 4
---

# Contrôle de conformité

Le triage de risque avant paiement, en un seul appel. Exécute une validation IBAN complète, puis ajoute un **bloc compliance** : screening sanctions de la banque teneuse de compte (OFAC), statut FATF du pays, joignabilité SEPA (SCT / SDD / SCT Inst), participation à la Verification of Payee, et un **score de risque 0–100** sur lequel votre code ou votre agent peut brancher sa décision.
...
| `sanctions.bank_sanctioned` | La banque teneuse de compte (BIC8) est désignée sur la liste OFAC. |
...
|---|---|
| Liste de sanctions (OFAC) | Hebdomadaire — voir `meta.sanctions_as_of` dans chaque réponse |
