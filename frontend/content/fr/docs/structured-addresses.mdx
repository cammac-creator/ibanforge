...
> **État au 2 septembre 2026.** Le 27 août 2026, Swift a reporté tous les changements « paiements » de sa Standards Release de novembre 2026, retrait des adresses non structurées compris, avec une mise à jour promise pour décembre 2026 au plus tard. SIX, l'Eurosystème (T2 R2026.NOV) et les rulebooks de l'EPC étaient inchangés ce jour-là ; Fedwire a déplacé sa release à novembre 2027 ; la Banque d'Angleterre attend un report de douze mois, sous réserve de confirmation. L'état rail par rail, avec chaque document et chaque phrase, est sur [Quelle est LA date ?](/fr/blog/2026-09-02-which-date-structured-addresses).
...
| **Novembre 2027** (était le 16 novembre 2026) | Release du Fedwire Funds Service reportée ; date exacte annoncée à l'automne 2026 ; la FAQ « format » dit encore « As of Nov 16 » | Federal Reserve Financial Services |
...
Vous tenez une QR-facture suisse plutôt qu'une adresse nue ? [`POST /v1/ch/qr-bill/check`](/docs/swiss-qr-iban) lit toute la charge utile et dit si ses adresses sont structurées (type S) ou encore combinées (type K), avec une forme structurée proposée.
