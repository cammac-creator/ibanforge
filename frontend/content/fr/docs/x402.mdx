...
| `POST /v1/iban/batch` | $0.002 USDC par IBAN (1 IBAN = $0.002, 100 = $0.20) |
| `GET /v1/bic/:code` | $0.003 USDC |
| `POST /v1/iban/compliance` | $0.02 USDC |
| `GET /v1/ch/clearing/:iid` | $0.003 USDC |

Le prix du lot est par IBAN et facture sur la taille de la liste envoyee : un
lot d'un seul IBAN coute $0.002, pas le prix d'un lot complet.
