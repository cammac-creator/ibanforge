...
description: "Connecter IBANforge à Claude, Cursor et tout agent MCP : le paquet npm ibanforge-mcp, un endpoint hébergé sans installation, sept outils, et des résultats qui disent quoi faire ensuite."
order: 5
---
...
Après enregistrement, redémarrez le client. Six outils IBANforge apparaissent dans le menu des outils.
...
- Les sept outils rendent le même JSON que l'API REST, en texte et en `structuredContent` MCP.
