...
description: "Connecter IBANforge à Claude, Cursor et tout agent MCP : le paquet npm ibanforge-mcp, un endpoint hébergé sans installation, six outils, et des résultats qui disent quoi faire ensuite."
order: 5
---
...
- Les six outils rendent le même JSON que l'API REST, en texte et en `structuredContent` MCP.
