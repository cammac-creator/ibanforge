...
Ein einziger POST, keine Karte, keine Wallet. Ganz ohne Body verlangt der Schlüssel nichts und ist das monatliche Grundkontingent auf allen Endpunkten wert; ein Aufruf von `POST /v1/keys/claim` hebt ihn danach auf das volle Kontingent. Mit einer Adresse, wie unten, wird er sofort mit dem vollen Kontingent ausgestellt:
