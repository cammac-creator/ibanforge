...
description: "IBANforge mit Claude, Cursor und jedem MCP-Agenten verbinden: das npm-Paket ibanforge-mcp, ein gehosteter Endpoint ohne Installation, acht Tools und Ergebnisse, die sagen, was als Nächstes zu tun ist."
order: 5
---
...
Nach dem Speichern den Client neu starten. Acht IBANforge-Tools erscheinen im Tool-Menü.
...
- Alle acht Tools liefern dasselbe JSON wie die REST-API, als Text und als MCP-`structuredContent`.
