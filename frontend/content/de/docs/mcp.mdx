...
description: "IBANforge mit Claude, Cursor und jedem MCP-Agenten verbinden: das npm-Paket ibanforge-mcp, ein gehosteter Endpoint ohne Installation, sechs Tools und Ergebnisse, die sagen, was als Nächstes zu tun ist."
order: 5
---
...
- Alle sechs Tools liefern dasselbe JSON wie die REST-API, als Text und als MCP-`structuredContent`.
