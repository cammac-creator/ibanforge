...
description: "IBANforge mit Claude, Cursor und jedem MCP-Agenten verbinden: das npm-Paket ibanforge-mcp, ein gehosteter Endpoint ohne Installation, fünf Tools und Ergebnisse, die sagen, was als Nächstes zu tun ist."
order: 5
---
...
Nach dem Speichern den Client neu starten. Fünf IBANforge-Tools erscheinen im Tool-Menü.
...
- Alle fünf Tools liefern dasselbe JSON wie die REST-API, als Text und als MCP-`structuredContent`.
