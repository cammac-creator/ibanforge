...
**Ausgabe:** IBAN-Validierungsergebnis + Sanktionspruefungsstatus (OFAC) + SEPA-Instant-Erreichbarkeit + VoP-Teilnehmerpruefung + Risiko-Score (0-100). Kosten: $0.02 USDC (identisch mit `/v1/iban/compliance`).
