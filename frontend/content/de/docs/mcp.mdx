...
Vollstaendiger Compliance-Check mit IBAN-Validierung, Sanktionspruefung, SEPA-Instant-Erreichbarkeit, VoP-Teilnehmerpruefung und zusammengesetztem Risiko-Score.
...
**Ausgabe:** IBAN-Validierungsergebnis + Sanktionspruefungsstatus (OFAC/EU/UN) + SEPA-Instant-Erreichbarkeit + VoP-Teilnehmerpruefung + Risiko-Score (0-100). Kosten: $0.02 USDC (identisch mit `/v1/iban/compliance`).
...
>
> Ja, diese IBAN ist gültig. Sie gehört zur **UBS Switzerland AG** in Zürich, Schweiz — BIC UBSWCHZH, Schweizer BC-Nummer 00230, SIC-Teilnehmer mit CHF Instant Payments.
