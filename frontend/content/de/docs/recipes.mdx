---
title: "Rezepte: IBAN validieren in Python, Node, PHP, Sheets, n8n"
...
## Python {#iban-validieren-in-python}
...
## Node.js / TypeScript {#iban-validieren-in-node}
...
## Google Sheets {#iban-validieren-in-google-sheets}
...
## KI-Agenten (MCP) {#iban-validieren-mit-einem-agenten}
