...
nur auf dieser Route und kommt um Mitternacht UTC zurück. Der Schlüssel gilt auf allen Endpunkten:
Batch, BIC, Schweizer Clearing, Compliance. Er wird pro Monat gezählt, und erst die Beanspruchung
hebt ihn auf 200 Anfragen pro Monat. Wer ohnehin nur einzelne IBANs prüft, kommt mit der Kostprobe
ohne Schlüssel womöglich aus.
