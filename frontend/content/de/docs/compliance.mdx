...
| `sanctions.bank_sanctioned` | Die kontoführende Bank (BIC8) ist auf der OFAC-Liste gelistet. |
...
|---|---|
| Sanktionsliste (OFAC) | Wöchentlich — siehe `meta.sanctions_as_of` in jeder Antwort |
