...
Rufen Sie detaillierte Institutsinformationen anhand eines BIC/SWIFT-Codes ab. Die Datenbank enthält über 121.000 BIC-Einträge aus öffentlichen Quellen (GLEIF, SWIFT-Verzeichnis, Bundesbank, SIX, NBP), mit LEI-Anreicherung für ~38K Einträge aus GLEIF.
