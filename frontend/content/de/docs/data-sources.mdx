...
Quelle: **Bank of England (List of Banks, 2026-09)**, die monatliche Liste der Institute, denen die Prudential Regulation Authority das Einlagengeschäft erlaubt. Genutzt mit der schriftlichen Erlaubnis der Bank of England, deren Bedingung die Nennung der Bank **zusammen mit dem Monat der Liste** ist — deshalb trägt jeder `pra_authorisation`-Block ein `list_month`, gelesen aus den geladenen Daten und nie von Hand geschrieben.
