...
> **Stand am 2. September 2026.** Am 27. August 2026 hat Swift alle Zahlungsverkehrs-Änderungen seines Standards Release vom November 2026 verschoben, die Abschaffung unstrukturierter Adressen eingeschlossen, mit einem spätestens im Dezember 2026 versprochenen Update. SIX, das Eurosystem (T2 R2026.NOV) und die EPC-Rulebooks waren an diesem Tag unverändert; Fedwire hat sein Release auf November 2027 verlegt; die Bank of England erwartet zwölf Monate Aufschub, unter Vorbehalt der Bestätigung. Der Stand Schiene für Schiene, mit jedem Dokument und jedem Satz, steht auf [Welches Datum ist DAS Datum?](/de/blog/2026-09-02-which-date-structured-addresses).
...
| **November 2027** (war 16. November 2026) | Release des Fedwire Funds Service verschoben; genaues Datum wird im Herbst 2026 bekannt gegeben; die Format-FAQ sagt noch «As of Nov 16» | Federal Reserve Financial Services |
...
Sie halten eine Swiss-QR-Rechnung statt einer blossen Adresse? [`POST /v1/ch/qr-bill/check`](/docs/swiss-qr-iban) liest die ganzen Nutzdaten und sagt, ob ihre Adressen strukturiert (Typ S) oder noch kombiniert (Typ K) sind, mit vorgeschlagener strukturierter Form.
