...
description: "Eine Bankleitzahl zu prüfen heisst nicht, eine Prüfziffer zu rechnen. Die Deutsche Bundesbank veröffentlicht jeden Monat, welche Codes vergeben sind, wem sie gehören und welche stillgelegt werden. Drei echte Antworten der API, Feld für Feld; die Kostprobe ohne Schlüssel deckt bis zu 25 Prüfungen pro Woche."
date: "2026-09-07"
faq:
  ...
  - q: "Was kostet die Prüfung?"
    a: "Nichts, um anzufangen. Ganz ohne Schlüssel: bis zu 25 IBAN-Prüfungen pro Woche und Adresse, nur auf der Validierungsroute, zum Ausprobieren. Ein Schlüssel ohne E-Mail: 200 Anfragen im Monat, sobald er beansprucht ist; ganz ohne Adresse genommen, beginnt er mit 25 im Monat, auf allen Endpunkten. Und eine einzelne Bankleitzahl lässt sich auf ihrer eigenen Seite unter /de/blz nachschlagen, ganz ohne Aufruf."
---
...
Ohne Schlüssel, direkt aus dem Terminal: Die Kostprobe ohne Schlüssel beantwortet bis zu 25 Aufrufe pro Woche und Adresse, nur auf dieser Route.
...
Die Antwort ist vollständig, und sie enthält einen Block `trial`, der sagt, wie viele Aufrufe in dieser Woche noch frei sind. Für den Betrieb nehmen Sie einen [Schlüssel ohne E-Mail](/de/docs/api-keys): 200 Anfragen im Monat, sobald er beansprucht ist, ohne Karte; wer eine ganze Datei prüfen will, nimmt [`POST /v1/iban/batch`](/de/docs/iban-validate) mit bis zu hundert IBANs pro Aufruf. Und wer keine Zeile Code schreiben möchte, findet [jede Bankleitzahl auf ihrer eigenen Seite](/de/blz), mit genau dieser Antwort darauf.
