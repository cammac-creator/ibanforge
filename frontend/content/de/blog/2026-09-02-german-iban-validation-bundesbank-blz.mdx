...
Die Bankleitzahlendatei führt den vollen elfstelligen BIC pro BLZ. Deshalb löst eine Sparkasse zu ihrem eigenen BIC auf und nicht zum gemeinsamen BIC8 ihrer Landesbank: Die Zuordnung ist veröffentlicht, wir geben sie nur weiter. In der Antwort trägt `bic` den Code und den Banknamen, und `sepa.basis: "national_register"` sagt, dass der BIC aus dem Register gelesen und nicht abgeleitet wurde. Für ein Auszahlungssystem, das den BIC neben der IBAN speichert, ist das der Wert, den man speichert.
