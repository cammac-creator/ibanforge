...
Identität und Erlaubnis sind zwei Fragen. Zu wissen, *wer* ein Institut ist, sagt nicht, was es tun darf. Wo eine Aufsichtsbehörde die Antwort veröffentlicht, sollte ein Lookup sie mitführen — samt Herkunft. Noch einmal `BARCGB22` (Name und FRN des Instituts sind hier ausgelassen):
