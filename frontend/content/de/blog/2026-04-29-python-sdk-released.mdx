...
key = IBANforge.generate_api_key("sie@company.com")
...
| `lookup_ch_clearing(iid)` | `/v1/ch/clearing/{iid}` | $0.003 | 1.100+ SIX-BankMaster-Einträge — vollständige Zahlungsschienen-Teilnahme + QR-IID, die tiefsten Schweizer Clearing-Daten aller öffentlichen APIs |
| `check_compliance(iban)` | `/v1/iban/compliance` | $0.02 | Sanktionen OFAC + FATF + SEPA Instant + VoP + Risk Score |
...
#   "sepa": {"reachable": true, "instant": null},
#   "vop": {"participant": null},
#   "risk_score": 5,
