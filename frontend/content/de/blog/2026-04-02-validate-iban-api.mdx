...
[IBANforge](https://ibanforge.com) ist eine REST-API, die vollstaendige IBAN-Validierung -- Pruefsumme, Laenderregeln, BBAN-Parsing -- durchfuehrt und den BIC-Code in derselben Antwort aufloest, gegen den ueber 121.000 Eintraege umfassenden GLEIF-Datensatz, der von Zentralbanken verwendet wird. Eine POST-Anfrage, eine strukturierte JSON-Antwort.
