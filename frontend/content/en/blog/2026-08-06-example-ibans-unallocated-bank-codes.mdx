...
**Need safe test IBANs whose bank codes are real?** We built the honest version: the [test IBAN generator](/tools/test-iban) draws register-allocated codes live, with the proof attached.
