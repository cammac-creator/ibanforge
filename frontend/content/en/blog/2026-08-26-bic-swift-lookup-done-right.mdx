...
Which register answered, what an absence means there, and how often each source moves: [data sources & provenance](/en/docs/data-sources). The country where our directory goes deepest is Switzerland, down to clearing participation and the QR-IID allocation — see [Swiss QR-IBAN & QR-IID](/en/docs/swiss-qr-iban).

Try any BIC above, or your own, in the [playground](/en/playground) and read the fields rather than the headline. That is the whole argument.
