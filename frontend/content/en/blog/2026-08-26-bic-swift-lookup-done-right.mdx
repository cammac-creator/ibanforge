...
Identity and permission are different questions. Knowing *who* an institution is does not tell you what it is allowed to do. Where a regulator publishes the answer, a lookup should carry it — and carry it with its provenance. `BARCGB22` again (the firm's name and FRN are left out here):
