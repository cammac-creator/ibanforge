...
| `lookup_bic(code)` | `/v1/bic/{code}` | $0.003 | 121k+ BIC entries (38K LEI-enriched via GLEIF) — bank, country, city, LEI |
| `lookup_ch_clearing(iid)` | `/v1/ch/clearing/{iid}` | $0.003 | 1,100+ SIX BankMaster entries — full rail participation + QR-IID, the deepest Swiss clearing data in any public API |
