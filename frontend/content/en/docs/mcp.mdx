...
description: "Connect IBANforge to Claude, Cursor and any MCP agent: the ibanforge-mcp npm package, a hosted endpoint with nothing to install, five tools, and results that say what to do next."
order: 5
---
...
- All five tools return the same JSON as the REST API, both as text and as MCP `structuredContent`.
