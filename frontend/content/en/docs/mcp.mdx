...
description: "Connect IBANforge to Claude, Cursor and any MCP agent: the ibanforge-mcp npm package, a hosted endpoint with nothing to install, eight tools, and results that say what to do next."
order: 5
---
...
After saving, restart the client. Eight IBANforge tools appear in the tools menu.
...
- All eight tools return the same JSON as the REST API, both as text and as MCP `structuredContent`.
