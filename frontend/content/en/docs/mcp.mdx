...
**Output:** IBAN validation result + sanctions screening status (OFAC) + SEPA Instant reachability + VoP participant check + risk score (0-100). Cost: $0.02 USDC (same as `/v1/iban/compliance`).
