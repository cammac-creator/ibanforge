...
description: "POST /v1/iban/compliance — bank-level sanctions screening (OFAC/EU/UN/SECO), FATF status, SEPA reachability, VoP participation, and a 0–100 risk score."
order: 4
---
...
| `sanctions.bank_sanctioned` | The holding bank (BIC8) is designated on OFAC, EU, UN or SECO lists. |
| `sanctions.matched_lists` | Which lists matched, e.g. `["OFAC", "EU"]`. Empty when clean. |
