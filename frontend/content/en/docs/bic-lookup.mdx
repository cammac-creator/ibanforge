...
Look up detailed institution information by BIC/SWIFT code. The database contains 121,000+ BIC entries from public sources (GLEIF, SWIFT directory, Bundesbank, SIX BankMaster, NBP), with LEI enrichment for ~38K rows sourced from GLEIF.
