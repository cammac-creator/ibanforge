...
> **State on 2 September 2026.** On 27 August 2026 Swift deferred all payments changes of its November 2026 Standards Release, the retirement of unstructured addresses included, with an update promised by December 2026 at the latest. SIX, the Eurosystem (T2 R2026.NOV) and the EPC rulebooks were unchanged on that day; Fedwire moved its release to November 2027; the Bank of England expects a twelve-month deferral, subject to confirmation. The rail-by-rail state, with every document and sentence, is on [Which date is THE date?](/en/blog/2026-09-02-which-date-structured-addresses).
...
| **November 2027** (was 16 November 2026) | Fedwire Funds Service release rescheduled; exact date to be announced in the fall of 2026; the format FAQ still reads "As of Nov 16" | Federal Reserve Financial Services |
