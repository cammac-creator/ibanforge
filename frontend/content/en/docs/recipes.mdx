...
1. [Download the three Apps Script files](/integrations/ibanforge-sheets-e3a66243a652.zip) and unzip them. In a test spreadsheet, open **Extensions → Apps Script**.
