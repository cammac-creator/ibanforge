...
## Python {#validate-iban-in-python}
...
## Node.js / TypeScript {#validate-iban-in-node}
...
## Google Sheets {#validate-iban-in-google-sheets}
...
## AI agents (MCP) {#validate-iban-with-an-ai-agent}
