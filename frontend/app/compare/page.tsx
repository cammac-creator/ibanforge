...
const FEATURES = [
  ...
  { label: "Countries supported", ibanforge: "80+", ibancom: "95+", ibanapi: "80+", abstract: "70+" },
  { label: "LEI / GLEIF data", ibanforge: "Yes", ibancom: "No", ibanapi: "No", abstract: "No" },
  { label: "Batch validation", ibanforge: "Yes (10/call)", ibancom: "No", ibanapi: "Yes", abstract: "No" },
